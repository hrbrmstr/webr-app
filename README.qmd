...
Please hit up [this terribly coded dashboard app](https://rud.is/webr-dash/no-dplyr.html) to see some fancier use. I'll be converting that to modules and expandin git a bit. 